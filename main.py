...
def create_train_loader(args, **kwargs):
    train_dataset = datasets.CIFAR10('/workspace/model-training.git', train=True, download=True,
...
def create_test_loader(args, **kwargs):
    test_dataset = datasets.CIFAR10('/workspace/model-training.git', train=False, download=True,
        transform=transforms.Compose([
            transforms.ToTensor(),
            transforms.Normalize((0.4914, 0.4822, 0.4465), (0.2023, 0.1994, 0.2010)),
        ]))
